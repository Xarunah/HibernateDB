...
values (1,'The Marvel Cinematic Universe (MCU) movie franchise is a series of interconnected superhero films produced by Marvel Studios.
...
INSERT INTO franchise (franchise_id, description, name)
values (2,'The X-Men movie franchise is a series of superhero films based on the popular Marvel Comics characters, the X-Men.
...
INSERT INTO franchise (franchise_id, description, name)
values (3,'The Jurassic Park movie franchise is a series of science-fiction adventure films that began with the release of the first film in 1993,
...
VALUES (1 , 'Spider-Man: No Way Home', 'Action', '2021', 'Jon Watts',
...
INSERT INTO movie(movie_id, title, genre, realise,  director, movie_picture, trailer, franchise_id)
VALUES (2 , 'X-Men: Apocalypse', 'Action', '2016', 'Bryan Singer',
...
INSERT INTO movie(movie_id, title, genre, realise,  director, movie_picture, trailer, franchise_id)
VALUES (3 , 'Jurassic World: Fallen Kingdom', 'Science Fiction', '2018', 'J. A. Bayona',
...
INSERT INTO movie(movie_id, title, genre, realise,  director, movie_picture, trailer, franchise_id)
VALUES (4, 'Avengers: Infinity War', 'Science Fiction', '2018', 'Anthony Russo',
...
INSERT INTO movie(movie_id, title, genre, realise,  director, movie_picture, trailer, franchise_id)
VALUES (5 , 'Jurassic World: Dominion', 'Science Fiction', '2022', 'Colin Trevorrow',
...
INSERT INTO character(character_id, character_name, alias, gender, character_picture)
VALUES (2, 'Psylocke', null, 'female', 'https://i.pinimg.com/originals/35/e6/1f/35e61fc90f094998a916035c3824bd69.jpg');

INSERT INTO character(character_id, character_name, alias, gender, character_picture)
VALUES (3, 'Owen Grady', 'Owen', 'male', 'https://upload.wikimedia.org/wikipedia/en/4/40/Owen_Grady_%28Chris_Pratt%29.jpg');
